...
<head>
	...
	<!-- Document Title
	============================================= -->
	<title>index_status_login</title>
...
<body class="stretched has-plugin-easing has-plugin-bootstrap has-plugin-html5video device-xs">
	...
	<div id="wrapper" class="clearfix">
			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-dark-logo="images/neulbo_logo.png"><img src="images/logo.png" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="images/neulbo_logo.png"><img src="images/logo@2x.png" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
						...
						<nav class="primary-menu">
							...
							<ul class="menu-container">
								...
								<li class="menu-item">
									<a class="menu-link" href="member_info_modification.jsp"><div><i class="icon-user4"></i>마이페이지</div></a>
				...
				<div class="vertical-middle">
					<div class="container text-center py-5 py-md-0">
						...
						<div class="heading-block border-bottom-0">
							<h4>늘 보고 싶은 당신을 위해</h4>
							<span>지금 바로 검색하세요!</span>
						</div>
		...
		<footer id="footer" class="dark" >
			...
			<!-- Footer Widgets
				============================================= -->
				<div class="footer-widgets-wrap" style="padding: 30px 0; background-color: #202020; border:0;">
