...
<body class="stretched">
         ...
         <div id="header-wrap"  style="background-color: #202020;">
            <div class="container">
               <div class="header-row">
                  ...
                  ============================================= -->
                  <div id="logo">
                     <a href="index.html" class="standard-logo" data-dark-logo="images/neulbo_logo.png"><img src="images/neulbo_logo.png" alt="Canvas Logo"></a>
                  ...
                  <nav class="primary-menu">
                     ...
                     <ul class="menu-container">
                        <li class="menu-item">
                           <a class="menu-link" href="main.html"><div><i class="icon-camera3"></i>영화 검색</div></a>
                        ...
                        <li class="menu-item">
                           <a class="menu-link" href="free_post.html"><div><i class="icon-list-alt"></i>자유게시판</div></a>
                           
                        </li>
                        <li class="menu-item">
                           <a class="menu-link" href="join.html"><div><i class="icon-user4"></i>회원 가입</div></a>
                           
                        </li>
                        <li class="menu-item">
                           <a class="menu-link" href="login.html"><div>로그인</div></a>
   ...
   <div id="wrapper" class="clearfix">
      ...
      <% 
		 ...
		 double score = reviewDao.score(1);
                  ...
                  <div class="col-lg-8">
                    <div class="row align-items-center">
                        <div style="padding:0 0 0 0;"class="col-lg-6">
                            <img style="height: 100%; width: 100%;" src="https://images.justwatch.com/poster/8589183/s592/baempaieo-daieori" alt="포스터">
                            <!--<img src="<%= dto.getThumbnail_Path() %>" alt="poster">-->
                        </div>
                        <div class="col-lg-6">
                            <br>
                            <h6 style="color: rgba(255, 255, 255, 0.773);" class="h1 mb-4"><%=dto.getTitle() %></h6>
                            <p style="font-size: 14px; color: rgba(255, 255, 255, 0.436);">2019년 12월 Netflix에서 방영을 시작한 판타지물. 안제이 삽코프스키의 동명의 판타지 소설 시리즈를 원작으로 한다. 사람들에게 악마의 창조물, 돌연변이라 불리는 고독한 괴물 사냥꾼 리비아의 게롤트가 운명을 향해 머나먼 여정을 떠난다. 때로는 인간이 괴물보다 사악하고 잔인한 이 세상에서, 그는 자신이 있어야 할 자리를 찾고자 고군분투한다. 하지만 운명은 그를 두 여인에게로 인도한다. 강력한 힘을 지닌 여자 마법사와 위험한 비밀을 간직한 공주. 세 사람은 점점 불안해지는 대륙에서 살아나갈 방법을 배워야만 한다. 운명으로 묶인 그들의 싸움이 시작된다.</p>
                            <div class="tab-content" id="side-tab-tabContent">
                                <div class="tab-pane fade show active" id="platform" role="tabpanel" aria-labelledby="side-tab-niche-tab">
                                   ...
                                   <p style="font-size:16px; color:white;" class="op-07 mb-5"><%= dto.getPlatform_Name()%><!--플랫폼 정보 넣으면 됩니다.--></p>
                                </div>
