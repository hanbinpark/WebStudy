<%@page import="com.model.CommentsDTO"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.model.CommentsDAO"%>
					...
					<div class="row gutter-40 col-mb-80">
						...
						<div class="postcontent col-lg-9 order-lg-last">
							...
							<div class="single-post mb-0">
								...
								<button onclick="location.href='PostLikeService?no=<%=no %>&like=<%=dto.getP_Like() %>'" class="button button-3d button-black m-0" id="register-form-submit" name="register-form-submit" value="register">추천</button>
								<br>
								<br>
								<%
									...
									function editComment(index) {
									    ...
									    xhr.onreadystatechange = function() {
									        if (xhr.readyState === XMLHttpRequest.DONE && xhr.status === 200) {
									            ...
									            var editButtons = document.getElementsByClassName("edit-button");
									            for (var i = 0; i < editButtons.length; i++) {
									                editButtons[i].style.display = "block"; // 수정 버튼 나타내기
									            }
									        }
									    };
								...
								<form action="CommentWriteService" method="post">
									...
									<button class="button button-3d button-black m-0" id="register-form-submit" name="register-form-submit" value="register">등록</button>
								</div>
