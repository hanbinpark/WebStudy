...
import com.model.BoardFileDAO;
import com.model.BoardFileDTO;
...
public class PostUpdateService extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * HttpSession session = request.getSession(); MemberDTO info =
		 * (MemberDTO)session.getAttribute("info");
		 * 
		 * String id = info.getId();
		 */
		request.setCharacterEncoding("EUC-KR");
		String id= "user";
		String path = "C:/Users/gjaischooll/Desktop/WebStudy/Test/Project404/src/main/webapp/upload";
