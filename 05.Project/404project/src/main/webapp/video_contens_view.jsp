               ...
               <%
               		if (info != null){
               			...
               			%>
               				...
               				<div style="margin: 1em 0 1em 0;"class="col-6">
			                  <button style="background-color: gray;" class="button m-0" type="submit" id="template-contactform-submit" name="template-contactform-submit" onclick="location.href='login_join.jsp'">로그인 하러 가기</button>
			               	</div>
               			<%
               		}
               %>
